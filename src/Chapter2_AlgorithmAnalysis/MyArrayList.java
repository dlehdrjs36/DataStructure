...
public class MyArrayList<T> implements List<T> {
	...
	//해당하는 값을 가지는 인덱스 번호를 검사, 추가한부분
	@Override
	public int indexOf(Object target) {
		// TODO: FILL THIS IN!
		for(int idx=0; idx<size; idx++) {
			// 조건을 equals(target, array[i])로 변경하기
			if ( target == null? get(idx) == null : target.equals(get(idx))) {		
				return idx;
			}
		}
		//못 찾은경우
...
//추가한 부분
	...
	public T remove(int index) {
		...
		// array[index]는 get(index)로 할 수도 있음
		T result = array[index];
		
		//삭제되는 요소의 뒤의 값을 한 칸씩 당긴다. size는 size-1로 수정하기
	...
	public T set(int index, T element) {
		...
		//이전 인덱스의 값, array[index]는 get(index)로도 할 수 있음
		T result = array[index];
		array[index] = element;
